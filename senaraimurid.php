    ...
    <div class="main_content">
        ...
        <div class="info">
            ...
            <form action="search.php" method='post'>
                <input type="text" name="carian" class="search" placeholder="Cari murid..." required>
            ...
            while ($row = mysqli_fetch_array($pengquery)){
                echo '<tr>
                    ...
                    <td>'.$row['nama'].'</td>
                    <td>'.$row['notel'].'</td>
                    <td><form action="deletepeng.php" method="post" style="display:inline;"><input type="hidden" name="idpeng" value="'.$row['idpeng'].'"><button type="submit" class="fabutton" onclick="return confirm(\'Adakah anda pasti mahu memadam pengguna ini?\');"><i class="fas fa-trash-alt"></i></button></form></td>
                    </tr>';
            }
            ?>
            </table>
