...
$skor = mysqli_fetch_assoc(mysqli_query($conn,"SELECT markah FROM perekodan WHERE idpeng='$idpeng' and idtopik='$idtopik'"))
?>
...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="info">
            ...
            <p style="font-size:25px;float:right;"> Skor anda: <?php print $skor['markah'];?>% </p>
            <br><br>
            <?php
            $index=0;
            while ($soalan = mysqli_fetch_array($soalanq)){
                ...
                while ($pilihan = mysqli_fetch_array($pilihanq)){
                    ...
                    if ($ans != "checked" and $pilihan['jwp']=="1"){
                        $ans = "checked";
                        $keraguan = "kebetulan";
                    }
            ...
            ?>
            <button class="btn" style="float:right;" onClick="javascript:window.location='kuiz.php'">Balik</button>
</div></div>
</div></div>
</body>
</html>