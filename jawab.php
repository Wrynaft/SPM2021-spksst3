...
<div class="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="info">
            ...
            <br><br>
            <form action="semak.php" method='post' id='borang'>
            <?php
            $index=0;
            while ($soalan = mysqli_fetch_array($soalanq)){
                ...
                while ($pilihan = mysqli_fetch_array($pilihanq)){
                    ...
                    echo '<label class="container">'.$option.'<input type="radio" name="jawapan['.$index.']" value="'.$indexp.'" required><span class="checkmark"></span></label>';
                    $indexp = $indexp + 1;
                }
                echo '</div><br><br>';
                $index=$index + 1;
            ...
            ?>
            <button class="btn" style="float:right;" type="submit">Hantar</button>
            </form>
</div></div>
</div></div>
</body>
